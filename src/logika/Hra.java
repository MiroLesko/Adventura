...
public class Hra implements IHra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazPouzi(herniPlan));
    ...
    public String vratUvitani() {
        return "Vitajte.\n" +
               "Bogota, drogy, letisko. Jednoducho utečte!\n" +
               "Napíšte 'napoveda', ak si neviete dať rady, čo ďalej.\n" +
               "\n" +
    ...
    public String vratEpilog() {
        return "Vďaka, že ste si zahrali.  Ahoj.";
    }
     ...
     */
     public String zpracujPrikaz(String radek) {
        ...
        if (platnePrikazy.jePlatnyPrikaz(slovoPrikazu)) {
            ...
            if (herniPlan.hracVyhral() || herniPlan.hracPrehral()) {
                konecHry = true;
            }
        }
        else {
