...
public class Prostor implements Subject {
    ...
    public Collection<Prostor> getVychody() {
     ...
     /**
     * Vloží vec do mapy vecí (veci). Pre vloženie je potrebná dvojica
     * názov veci a objekt veci. Názov je získaný metodou getNazev().
     * @param vec vstupným parametrom je vytvorený objekt veci.
     */
    public void vlozVec(Vec vec) {
      ...
      /**
     * Odoberie vec z mapy vecí (veci). Vec je z mapy odobraná na základe jej názvu.
     * @param nazev názov veci, ktorú chceme odobrať
     * @return odobraná vec
     */
    ...
    */
     ...
     * @return zamknutost vrátená hodnota true (priestor zamknutý) 
     *          alebo false (priestor otvorený)
     */
    public boolean getZamknutost(){
        return zamknutost;
    }
    
    /**
     * Nastavenie hodnoty zamknutost priestoru. 
     * @param zamknutost hodnota true/false, true v prípade zamknutia priestoru
     */
